...
{
    /// <summary>
    /// <para>表示 [GET] /v2/buckets/cdn/cache 接口的响应。</para>
    /// </summary>
    public class GetBucketCDNCacheV2Response : UpyunConsoleResponse
    {
            ...
            public class Data
            {
                public static class Types
                {
                    public class Rule
                    {
                        ...
                        public string[]? ResponseHeaderList { get; set; }
                    }
                }
                ...
                public Types.Rule[] SpecificRuleList { get; set; } = default!;
                ...
                public Types.Rule[] NoCahceRuleList { get; set; } = default!;
            }
        }
