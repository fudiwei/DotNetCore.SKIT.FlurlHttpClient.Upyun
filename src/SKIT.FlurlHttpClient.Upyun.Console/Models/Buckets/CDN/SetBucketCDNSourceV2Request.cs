...
namespace SKIT.FlurlHttpClient.Upyun.Console.Models
{
    ...
    /// </summary>
    public class SetBucketCDNSourceV2Request : UpyunConsoleRequest
    {
        ...
        public string? DomainFollowStatus { get; set; }
        ...
        public string? RedirectFollowStatus { get; set; }
        ...
        public Types.CDN CDN { get; set; } = new Types.CDN();
    }
}
