...
namespace SKIT.FlurlHttpClient.Upyun.Uss.Utilities
{
    ...
    public static class HMACUtility
    {
        ...
        public static byte[] HashWithSHA1(byte[] keyBytes, byte[] messageBytes)
        {
            ...
            return HMACSHA1.HashData(keyBytes, messageBytes);
#else
        ...
        public static EncodedString HashWithSHA1(string key, string messageData)
        {
            ...
            byte[] hashBytes = HashWithSHA1(keyBytes, messageBytes);
