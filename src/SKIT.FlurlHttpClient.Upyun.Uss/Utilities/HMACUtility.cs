...
namespace SKIT.FlurlHttpClient.Upyun.Uss.Utilities
{
    ...
    public static class HMACUtility
    {
        ...
        public static byte[] HashWithSHA1(byte[] secretBytes, byte[] msgBytes)
        {
        ...
        public static string HashWithSHA1(string secret, string message)
        {
            ...
            return BitConverter.ToString(HashWithSHA1(secretBytes, msgBytes)).Replace("-", "");
        }
    }
}
