...
namespace SKIT.FlurlHttpClient.Upyun.Uss.Utilities
{
    ...
    {
        private readonly static Hashtable _ctorCache = new Hashtable(capacity: 32);
        private readonly static Hashtable _getterCache = new Hashtable(capacity: 32);
        private readonly static Hashtable _setterCache = new Hashtable(capacity: 32);
