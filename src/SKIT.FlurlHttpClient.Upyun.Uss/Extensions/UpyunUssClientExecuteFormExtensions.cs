...
namespace SKIT.FlurlHttpClient.Upyun.Uss
{
    public static class UpyunUssClientExecuteFormExtensions
    {
        ...
        /// <para>
        /// REF: <br/>
        /// <![CDATA[ https://help.upyun.com/knowledge-base/form_api/#e5b08fe69687e4bbb6e4b88ae4bca0 ]]>
        /// </para>
        /// </summary>
        ...
        public static async Task<Models.UploadFileWithFormResponse> ExecuteUploadFileWithFormAsync(this UpyunUssClient client, Models.UploadFileWithFormRequest request, CancellationToken cancellationToken = default)
        {
            ...
            if (request.ExpireTimestamp is null)
                request.ExpireTimestamp = DateTimeOffset.Now.AddMinutes(30).ToUnixTimeSeconds();

            IFlurlRequest flurlReq = client
                .CreateFlurlRequest(request, HttpMethod.Post, request.BucketName);
            ...
            if (request.AllowedFileTypeList is not null)
            {
            ...
            if (request.AllowedFileSizeRange is not null)
            {
            ...
            if (request.AllowedImageWidthRange is not null)
            {
            ...
            if (request.AllowedHeightWidthRange is not null)
            {
            ...
            if (request.AsyncPretreatmentParameters is not null && request.AsyncPretreatmentParameters.Any())
            {
            ...
            return await client.SendFlurlRequestAsync<Models.UploadFileWithFormResponse>(flurlReq, httpContent: formContent, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
}
