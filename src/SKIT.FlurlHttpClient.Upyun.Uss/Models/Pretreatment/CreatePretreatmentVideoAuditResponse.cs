namespace SKIT.FlurlHttpClient.Upyun.Uss.Models
{
    ...
    public class CreatePretreatmentVideoAuditResponse : UpyunUssResponse
    {
        ...
        {
            internal class ResponseClassNewtonsoftJsonConverter : Newtonsoft.Json.Converters.Internal.ArrayLikeObjectReadOnlyConverterBase<CreatePretreatmentVideoAuditResponse>
            {
            }

            internal class ResponseClassSystemTextJsonConverter : System.Text.Json.Serialization.Internal.ArrayLikeObjectReadOnlyConverterBase<CreatePretreatmentVideoAuditResponse>
            {
            }
        }
