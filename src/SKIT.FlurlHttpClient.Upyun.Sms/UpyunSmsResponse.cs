...
namespace SKIT.FlurlHttpClient.Upyun.Sms
{
    ...
    /// 又拍云短信服务 API 响应的基类。
    /// </summary>
    public abstract class UpyunSmsResponse : ICommonResponse
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// 获取一个值，该值指示调用又拍云短信服务 API 是否成功（即 HTTP 状态码为 200/201/202/204）。
        /// </summary>
        /// <returns></returns>
        public virtual bool IsSuccessful()
        {
            return RawStatus == 200 || RawStatus == 201 || RawStatus == 202 || RawStatus == 204;
        }
    }
}
