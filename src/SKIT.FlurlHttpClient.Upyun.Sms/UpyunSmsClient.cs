...
namespace SKIT.FlurlHttpClient.Upyun.Sms
{
    ...
    public class UpyunSmsClient : CommonClientBase, ICommonClient
    {
        ...
        internal protected UpyunSmsClient(UpyunSmsClientOptions options, HttpClient? httpClient, bool disposeClient = true)
            : base(httpClient, disposeClient)
        {
            ...
            FlurlClient.WithHeader(HttpHeaders.Authorization, options.Token);
        ...
        /// <returns></returns>
        public IFlurlRequest CreateFlurlRequest(UpyunSmsRequest request, HttpMethod httpMethod, params object[] urlSegments)
        {
