    ...
    public class CodeAnalyzeTests
    {
        ...
        public void CodeAnalyze()
        {
            ...
            Assert.Null(Record.Exception(() =>
            {
                ...
                {
                    SdkAssembly = Assembly.GetAssembly(typeof(UpyunUssClient))!,
                    SdkRequestModelDeclarationNamespace = "SKIT.FlurlHttpClient.Upyun.Uss.Models",
                    SdkResponseModelDeclarationNamespace = "SKIT.FlurlHttpClient.Upyun.Uss.Models",
                    SdkExecutingExtensionDeclarationNamespace = "SKIT.FlurlHttpClient.Upyun.Uss",
            ...
            Assert.Null(Record.Exception(() =>
            {
                ...
                var options = new SourceFileAnalyzerOptions()
                {
                    ...
                    SdkRequestModelDeclarationNamespace = "SKIT.FlurlHttpClient.Upyun.Uss.Models",
                    SdkResponseModelDeclarationNamespace = "SKIT.FlurlHttpClient.Upyun.Uss.Models",
                    ProjectSourceRootDirectory = Path.Combine(projdir, "./src/SKIT.FlurlHttpClient.Upyun.Uss/"),
                    ProjectTestRootDirectory = Path.Combine(projdir, "./test/SKIT.FlurlHttpClient.Upyun.Uss.UnitTests/"),
